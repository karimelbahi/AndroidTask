...
import com.karim.task.data.BASE_URL
...
import com.karim.task.presentation.ui.mostPopular.mapper.MostPopularMapperImpl
...
class RetrofitModule {
    ...
    @Provides
    @Singleton
    fun provideMapperHelper(MBMapper: MostPopularMapperImpl): MostPopularMapper = MBMapper
